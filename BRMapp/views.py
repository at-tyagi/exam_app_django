...
# models is module unknown to program
...
def editBook(request):
    ...
    res=render(request,'BRMapp/edit_book.html',context={'form':form,'book':book})
    return res
...
def edit(request):
    ...
    # write view-book instead of view_book.html becouse some time this gives error as python variable dont go to html file
@login_required(login_url='/BRMapp/login/')
...
def search(request):
    ...
    res=render(request,'BRMapp/search_book.html',context={'form':form,'books':books})
    return res
